...
export interface BrowserProxyServiceClient extends grpc.Client {
	CloseSession(
		argument: _browser_proxy_v1_CloseSessionRequest,
		metadata: grpc.Metadata,
		options: grpc.CallOptions,
		callback: grpc.requestCallback<_browser_proxy_v1_CloseSessionResponse__Output>,
	...
	CreateSession(
		argument: _browser_proxy_v1_CreateSessionRequest,
		metadata: grpc.Metadata,
		options: grpc.CallOptions,
		callback: grpc.requestCallback<_browser_proxy_v1_CreateSessionResponse__Output>,
	): grpc.ClientUnaryCall;
	CreateSession(
		argument: _browser_proxy_v1_CreateSessionRequest,
		metadata: grpc.Metadata,
	...
	DownloadFile(
		argument: _browser_proxy_v1_DownloadFileRequest,
		metadata: grpc.Metadata,
		options?: grpc.CallOptions,
	): grpc.ClientReadableStream<_browser_proxy_v1_DownloadFileResponse__Output>;
	DownloadFile(
		argument: _browser_proxy_v1_DownloadFileRequest,
		options?: grpc.CallOptions,
	): grpc.ClientReadableStream<_browser_proxy_v1_DownloadFileResponse__Output>;
	...
	FetchHttp(
		argument: _browser_proxy_v1_FetchHttpRequest,
		metadata: grpc.Metadata,
		options: grpc.CallOptions,
		callback: grpc.requestCallback<_browser_proxy_v1_FetchHttpResponse__Output>,
	): grpc.ClientUnaryCall;
	FetchHttp(
		argument: _browser_proxy_v1_FetchHttpRequest,
		metadata: grpc.Metadata,
	...
	NavigatePage(
		argument: _browser_proxy_v1_NavigatePageRequest,
		metadata: grpc.Metadata,
		options: grpc.CallOptions,
		callback: grpc.requestCallback<_browser_proxy_v1_NavigatePageResponse__Output>,
	): grpc.ClientUnaryCall;
	NavigatePage(
		argument: _browser_proxy_v1_NavigatePageRequest,
		metadata: grpc.Metadata,
...
export interface BrowserProxyServiceHandlers
	...
	FetchHttp: grpc.handleUnaryCall<
