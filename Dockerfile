# Build stage
FROM oven/bun:1.3@sha256:7608db4aeb44f1fe8169cc8ec7055376b3013557b106407ccf092b00e426407d AS builder
WORKDIR /app
...
# Runtime stage
FROM oven/bun:1.3@sha256:7608db4aeb44f1fe8169cc8ec7055376b3013557b106407ccf092b00e426407d
WORKDIR /app
