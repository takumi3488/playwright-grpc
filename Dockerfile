# Build stage
FROM oven/bun:1.3@sha256:fbf8e67e9d3b806c86be7a2f2e9bae801f2d9212a21db4dcf8cc9889f5a3c9c4 AS builder
WORKDIR /app
...
# Runtime stage
FROM oven/bun:1.3@sha256:fbf8e67e9d3b806c86be7a2f2e9bae801f2d9212a21db4dcf8cc9889f5a3c9c4
WORKDIR /app
