# Build stage
FROM oven/bun:1.3@sha256:0733e50325078969732ebe3b15ce4c4be5082f18c4ac1a0f0ca4839c2e4e42a7 AS builder
WORKDIR /app
...
# Runtime stage
FROM oven/bun:1.3@sha256:0733e50325078969732ebe3b15ce4c4be5082f18c4ac1a0f0ca4839c2e4e42a7
WORKDIR /app
