# Build stage
FROM oven/bun:1.3@sha256:e90cdbaf9ccdb3d4bd693aa335c3310a6004286a880f62f79b18f9b1312a8ec3 AS builder
WORKDIR /app
...
# Runtime stage
FROM oven/bun:1.3@sha256:e90cdbaf9ccdb3d4bd693aa335c3310a6004286a880f62f79b18f9b1312a8ec3
WORKDIR /app
